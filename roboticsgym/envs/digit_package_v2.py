"""
This file defines the task of controlling the Digit robot to pick up a box with reference trajectory.
"""
...
from roboticsgym.envs.reference_trajectories.loadDigit import DigitPackageTrajectory
...
class DigitEnv(MujocoEnv, utils.EzPickle):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.ref_trajectory = DigitPackageTrajectory()
