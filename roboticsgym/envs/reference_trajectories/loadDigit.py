...
class DigitTrajectory:
    ...
    def read_csv(self, filepath):
        ...
        position_full = digit_state_distill.loc[
            :, "position_full_0":"position_full_29"
        ].to_numpy()

        velocity_full = digit_state_distill.loc[
            :, "velocity_full_0":"velocity_full_29"
        ].to_numpy()
        ...
        base_position = digit_state_distill.loc[
            :, "base_position_0":"base_position_2"
        ].to_numpy()

        base_velocity = digit_state_distill.loc[
            :, "base_velocity_0":"base_velocity_2"
        ].to_numpy()
