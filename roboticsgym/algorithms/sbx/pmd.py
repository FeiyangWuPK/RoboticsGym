# This file is a modified version of the original SAC from the Stable Baselines3 Jax library.
...
class SAC(OffPolicyAlgorithmJax):
    ...
    def update_critic(
        ...
        def mse_loss(params: flax.core.FrozenDict, dropout_key: jax.Array) -> jax.Array:  # type: ignore
    ...
    def update_actor(
        ...
        def actor_loss(params: flax.core.FrozenDict) -> Tuple[jax.Array, jax.Array]:  # type: ignore
    ...
    def update_temperature(
        ...
        def temperature_loss(temp_params: flax.core.FrozenDict) -> jax.Array:  # type: ignore
